/*
 ...
 MyFonts Webfont Build ID 3340645, 2017-02-05T10:01:01-0500
 ...
 License: http://www.myfonts.com/viewlicense?type=web&buildid=3340645
...
for(var fonts=[{fontFamily:"Campton",fontWeight:"bold",fontStyle:"normal",url:wfpath+"32F965_0"+suffix+"_0."+webfontType},{fontFamily:"Campton",fontWeight:"normal",fontStyle:"normal",url:wfpath+"32F965_1"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+webfontType+'")',css=css+("@font-face{font-family: "+fonts[i].fontFamily+";src:url("+fonts[i].url+")"+format+
